...
def print_usage():
    print('Use: proxy.py <port1,port2,port3>')
    print('     proxy.py -p <port1,port2,port3>')
    print('     proxy.py -b <ip> -p <port1,port2,port3>')
    print('     proxy.py -b 0.0.0.0 -p 80,2082,8080')
    print('     proxy.py 80,2082,8080')
...
def parse_args(argv):
    ...
    # Handle direct port argument (first argument without flags)
...
def main(host=LISTENING_ADDR, ports=LISTENING_PORTS):
    ...
    print("\033[0;34m━"*10,"\033[1;32m WEBSOCKET MULTI","\033[0;34m━\033[1;37m"*11,"\n")
...
screen -dmS pythonwe python proxy.py -p 80,8080,8880&
