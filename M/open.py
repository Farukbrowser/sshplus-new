#!/usr/bin/env python3
# encoding: utf-8
# Enhanced Multi-Port OPEN SOCKS Proxy
...
class Server(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            self.soc.listen(0)
            self.running = True
            print("OPEN SOCKS proxy server started on port %d" % self.port)
...
def main(host=IP, ports=LISTENING_PORTS):
    print("\033[0;34m━"*8,"\033[1;32m OPEN SOCKS MULTI-PORT","\033[0;34m━"*8,"\n")
